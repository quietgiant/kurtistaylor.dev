    ...
    return (
        <div className="index-page">
            ...
            <Container className="icon-links">
                <Link href="https://twitter.com/kurthasgame" target="_blank" rel="noreferrer">
                    <Twitter htmlColor="#1d9bf0"></Twitter>
                </Link>
                <Link href="https://github.com/quietgiant" target="_blank" rel="noreferrer">
                    <GitHub htmlColor="#238636"></GitHub>
                </Link>
                <Link href="https://www.linkedin.com/in/kurtis-j-taylor/" target="_blank" rel="noreferrer">
                    <LinkedIn htmlColor="#0a66c2"></LinkedIn>
                </Link>
                <Link href="res/docs/resume.pdf" target="_blank" rel="noreferrer">
